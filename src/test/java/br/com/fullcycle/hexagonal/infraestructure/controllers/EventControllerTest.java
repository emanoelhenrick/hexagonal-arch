...
class EventControllerTest {
    ...
    public void testCreate() throws Exception {
        ...
        var actualResponse = mapper.readTree(result);
        Assertions.assertEquals(event.date(), actualResponse.get("date").asText());
        Assertions.assertEquals(event.totalSpots(), actualResponse.get("totalSpots").asInt());
        Assertions.assertEquals(event.name(), actualResponse.get("name").asText());
        Assertions.assertEquals(event.partnerId(), actualResponse.get("partnerId").asLong());
    }
